    	...
    	<div id="innerWrap">
          <div id="content" class="margtop20 margbtm50">
            ...
            <div class="crankupcol2 margtop20">
            	<c:url var="register" value="/emailpwd"/>
				<form action="${register}" method="post" class="centered">
					...
					<div class="formsingle">
                   	  	<input type="text" name="userName" class="mediuminput" title="Registered Username"/>
                        <div class="errorBlock margbtm10">${userNameError}</div>
                    </div>
                    <div class="formsingle">
                    	<input type="submit" class="large orange kool" value="Submit" title="Submit"/>    
                 	</div>
				</form>
            </div>
